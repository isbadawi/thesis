...
or \code{DWH}, then we can safely abstain from instrumenting it. As a small
...
The "+ Prop" column in \tableref{tab:InstrumentationResults} shows the
...
% TODO(isbadawi): Revisit this paragraph after rerunning benchmarks.
