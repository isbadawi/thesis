...
order illustrated in \figref{fig:HandleLattice}.
...
\tableref{tab:HandleExprRules}; we write $in(id)$ to refer to the abstract
...
For our purposes, if the target of a variable access has the \code{DO} abstract
...
\matlab 7 in 2004. Given all this, it's reasonable to treat \code{feval} the
