...
% TODO(isbadawi): reverse -- instrument if handle, not avoid instrumenting if not handle
...
or \code{DWH}, then we can safely abstain from instrumenting it. We make the
decision based on the abstract value associated with the variable in the
