...
% TODO(isbadawi): Show example of trace and JSON callgraph
...
\begin{figure}
\lstinputlisting[numbers=none]{code/callgraph_builtins.m}
\caption{Dealing with builtin functions at runtime.}
