...
% TODO(isbadawi): Give a better breakdown of the cases. Possibly add a section
% with a more concrete description of the approach.
...
different cases we need to handle. % TODO(isbadawi): Clarify this sentence...
...
% TODO(isbadawi): Add a listing showing the code before using the Transformer.
